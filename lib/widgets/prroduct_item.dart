...
class ProductItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Product product = Provider.of<Product>(context, listen: false); // fica escutando
    final Cart cart = Provider.of<Cart>(context, listen: false); // fica escutando
    ...
    return ClipRRect(
      ...
      child: GridTile(
        ...
        footer: GridTileBar(
          ...
          leading: Consumer<Product>( // controla somente esse escopo mesmo que o listener esteja falso no pai desse nó.
